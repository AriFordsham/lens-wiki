...
* The @Bazaar@ comonad, which is used to characterize traversals and to implement many combinators is an indexed version of the Kleene Store comonad from Russell's <a href="http://arxiv.org/abs/1103.2841">"Functor is to Lens as Applicative is to Biplate: Introducing Multiplate"</a>. That type goes back farther to Twan van Laarhoven, who called it a @FunList@ in <a href="http://twanvl.nl/blog/haskell/non-regular1">"A non-regular data type challenge"</a>.
